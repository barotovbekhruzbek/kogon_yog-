               ...
               <div class="part-4">
                <div class="main-text">
                   ...
                   <div class="wrapper">
                       <div class="card">
                            <div class="icon-file">
                                <a href="document/Чораклик%20хисобот.%202020%20йил%201%20%20-%20чорак.pdf">
                    ...
                    <!--        4         -->
                       <div class="card">
                           <div class="icon-file">
                               <a href="document/Чоракликхисобот2021йил1-чорак.pdf">
                                   <i class="fa fa-file" aria-hidden="true"></i>
                ...
                <!--       2            -->
                   ...
                   <div class="wrapper">
                       ...
                       <div class="card">
                           <div class="icon-file">
                               <a href="document/Чораклик%20хисобот.2021йил3%20-чорак.pdf">
                                   <i class="fa fa-file" aria-hidden="true"></i>
                       ...
                       <div class="card">
                           <div class="icon-file">
                               <a href="document/Чоракликхисобот2022йил1-чорак.pdf">
                                   <i class="fa fa-file" aria-hidden="true"></i>
                       ...
                       <div class="card">
                           <div class="icon-file">
                               <a href="document/Чоракликхисобот2022%20йил2-чорак.pdf">
                                   <i class="fa fa-file" aria-hidden="true"></i>
                                   <p>2022-yil I chorak</p>
                                   <button class="btn-danger"> ko`rish </button>
                               </a>
