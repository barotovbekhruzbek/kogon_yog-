                ...
                <div class="card">
                    <div class="icon-file">
                        <a href="document/afflangan/2020.pdf">
                            ...
                            <p>2020 -yil Affillangan shaxslar ro`yxati </p>
                ...
                <div class="card">
                    <div class="icon-file">
                        <a href="document/afflangan/2017.pdf">
                            <i class="fa fa-file" aria-hidden="true"></i>
                            <p>2017 -yil Affillangan shaxslar ro`yxati</p>
                            <button class="btn-danger"> ko`rish </button>
                        </a>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="icon-file">
                        <a href="document/afflangan/2022.pdf">
                            <i class="fa fa-file" aria-hidden="true"></i>
                            <p>2022 -yil Affillangan shaxslar ro`yxati</p>
                            <button class="btn-danger"> ko`rish </button>
                        </a>
                    </div>
                </div>
