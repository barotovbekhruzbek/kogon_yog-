...
<body class="page-wrapper">
    ...
    <div class="bread-crumb">
        <div class="container">
            <div class="text"><a href="product.html">Document</a><i class="fa fa-angle-right"></i> Doc 1
                ...
                <div class="col-md-6 col-sm-6 col-xs-12 about-colmun">
                    <div class="about-content">
                        <div class="about-title">
                            <div class="section-title"><h2>1 - Doc nomi</h2></div>
